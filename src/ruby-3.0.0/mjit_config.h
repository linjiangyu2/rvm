...
#else
#define MJIT_HEADER_INSTALL_DIR "/usr/local/rvm/rubies/ruby-3.0.0/include/ruby-3.0.0/x86_64-linux"
#endif
#define MJIT_MIN_HEADER_NAME "rb_mjit_min_header-3.0.0.h"
#define MJIT_CC_COMMON   "/usr/bin/gcc", "-std=gnu99",
#define MJIT_CFLAGS      MJIT_ARCHFLAG "-w",
#define MJIT_OPTFLAGS    "-O3",
#define MJIT_DEBUGFLAGS  "-ggdb3",
#define MJIT_LDSHARED    "/usr/bin/gcc", "-std=gnu99", "-shared",
#define MJIT_DLDFLAGS    MJIT_ARCHFLAG "-Wl,--compress-debug-sections=zlib",
#define MJIT_LIBS        "-Wl,-rpath,/usr/local/rvm/rubies/ruby-3.0.0/lib", "-L/usr/local/rvm/rubies/ruby-3.0.0/lib", "-lruby",
