...
{
    rb_obj_write((VALUE)(m), ((VALUE *)(&m->v1)), (VALUE)(v), "./internal/imemo.h", 234);
}
static inline void
MEMO_V2_SET(struct MEMO *m, VALUE v)
{
    rb_obj_write((VALUE)(m), ((VALUE *)(&m->v2)), (VALUE)(v), "./internal/imemo.h", 240);
}
...
aliased_callable_method_entry(const rb_callable_method_entry_t *me)
{
 ...
 if (me->def->alias_count + me->def->complemented_count == 0) {
     rb_obj_write((VALUE)(me), ((VALUE *)(&me->def->body.alias.original_me)), (VALUE)(cme), "./vm_insnhelper.c", 3014);
 }
 else {
...
vm_search_super_method(const rb_control_frame_t *reg_cfp, struct rb_call_data *cd, VALUE recv)
{
 ...
 rb_raise(rb_eRuntimeError,
   ...
   " Specify all arguments explicitly.");
    ...
    cd->ci = vm_ci_new_runtime_(mid, vm_ci_flag(cd->ci), vm_ci_argc(cd->ci), vm_ci_kwarg(cd->ci), "./vm_insnhelper.c", 3603);
    (rb_obj_written((VALUE)(reg_cfp->iseq), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(cd->ci), "./vm_insnhelper.c", 3605));
    const struct rb_callcache *cc;
    VALUE klass = vm_search_normal_superclass(me->defined_class);
    if (!klass) {
        cc = vm_cc_new(klass, ((void *)0), vm_call_method_missing);
        rb_obj_write((VALUE)(reg_cfp->iseq), ((VALUE *)(&cd->cc)), (VALUE)(cc), "./vm_insnhelper.c", 3614);
    }
    else {
        ...
        if (cached_cme == ((void *)0)) {
            ...
            rb_obj_write((VALUE)(reg_cfp->iseq), ((VALUE *)(&cd->cc)), (VALUE)(cc = empty_cc_for_super), "./vm_insnhelper.c", 3629);
        }
        else if (cached_cme->called_id != mid) {
            const rb_callable_method_entry_t *cme = rb_callable_method_entry(klass, mid);
            cc = vm_cc_new(klass, cme, vm_call_super_method);
            rb_obj_write((VALUE)(reg_cfp->iseq), ((VALUE *)(&cd->cc)), (VALUE)(cc), "./vm_insnhelper.c", 3634);
        }
        else {
...
vm_defined(rb_execution_context_t *ec, rb_control_frame_t *reg_cfp, rb_num_t op_type, VALUE obj, VALUE needstr, VALUE v)
{
 ...
 break;
      ...
      case DEFINED_FUNC:
 klass = rb_class_of(v);
 if (rb_ec_obj_respond_to(ec, klass, v, rb_sym2id(obj), 1)) {
      ...
      case DEFINED_ZSUPER:
 {
  ...
  if (rb_ec_obj_respond_to(ec, klass, (((((reg_cfp)))->self)), id, 1)) {
...
{
    if (ic_serial == (ruby_vm_global_constant_state) && rb_ractor_main_p()) {
...
vm_once_dispatch(rb_execution_context_t *ec, ISEQ iseq, ISE is)
{
 ...
 rb_obj_write((VALUE)(ec->cfp->iseq), ((VALUE *)(&is->once.value)), (VALUE)(val), "./vm_insnhelper.c", 4649);
